...
## <a name="march-30-2021"></a><span data-ttu-id="9b1a9-111">2021 年 3 月 30 日</span><span class="sxs-lookup"><span data-stu-id="9b1a9-111">March 30, 2021</span></span>
...
## <a name="march-1-2021"></a><span data-ttu-id="9b1a9-141">2021 年 3 月 1 日</span><span class="sxs-lookup"><span data-stu-id="9b1a9-141">March 1, 2021</span></span>
...
### <a name="view-only-meeting-experience"></a><span data-ttu-id="9b1a9-155">僅供查看會議體驗</span><span class="sxs-lookup"><span data-stu-id="9b1a9-155">View-only meeting experience</span></span>
...
### <a name="offline-documentation"></a><span data-ttu-id="9b1a9-167">離線檔</span><span class="sxs-lookup"><span data-stu-id="9b1a9-167">Offline documentation</span></span>
...
### <a name="calendar-sharing"></a><span data-ttu-id="9b1a9-181">行事曆共用</span><span class="sxs-lookup"><span data-stu-id="9b1a9-181">Calendar sharing</span></span>
...
### <a name="advisor-for-teams-with-microsoft-365-learning-pathways"></a><span data-ttu-id="9b1a9-194">具有 Microsoft 365 學習路徑的 Teams 顧問</span><span class="sxs-lookup"><span data-stu-id="9b1a9-194">Advisor for Teams with Microsoft 365 Learning Pathways</span></span>
...
## <a name="october-27-2020"></a><span data-ttu-id="9b1a9-211">2020 年 10 月 27 日</span><span class="sxs-lookup"><span data-stu-id="9b1a9-211">October 27, 2020</span></span>
...
## <a name="october-16-2020"></a><span data-ttu-id="9b1a9-226">2020年10月16日</span><span class="sxs-lookup"><span data-stu-id="9b1a9-226">October 16, 2020</span></span>
...
## <a name="october-1-2020"></a><span data-ttu-id="9b1a9-241">2020年10月1日</span><span class="sxs-lookup"><span data-stu-id="9b1a9-241">October 1, 2020</span></span>
...
### <a name="calling-plans-support-for-austria-denmark-italy-portugal-sweden-and-switzerland"></a><span data-ttu-id="9b1a9-255">對奧地利、丹麥、義大利、葡萄牙、瑞典及瑞士的呼叫方案支援</span><span class="sxs-lookup"><span data-stu-id="9b1a9-255">Calling Plans support for Austria, Denmark, Italy, Portugal, Sweden, and Switzerland</span></span>
...
<span data-ttu-id="9b1a9-268">直接使用 Teams 直接透過您的 Android 電話薄進行呼叫。</span><span class="sxs-lookup"><span data-stu-id="9b1a9-268">Call using Teams directly through your Android Phonebook.</span></span>
...
### <a name="new-third-party-video-provider-riverbed"></a><span data-ttu-id="9b1a9-280">新增協力廠商影片提供者 Riverbed</span><span class="sxs-lookup"><span data-stu-id="9b1a9-280">New third-party video provider Riverbed</span></span>
...
## <a name="september-3-2020"></a><span data-ttu-id="9b1a9-295">2020 年 9 月 3 日</span><span class="sxs-lookup"><span data-stu-id="9b1a9-295">September 3, 2020</span></span>
...
## <a name="july-29-2020"></a><span data-ttu-id="9b1a9-350">2020 年 7 月 29 日</span><span class="sxs-lookup"><span data-stu-id="9b1a9-350">July 29, 2020</span></span>
...
### <a name="admins-can-control-outgoing-webhooks-at-the-user-level"></a><span data-ttu-id="9b1a9-363">系統管理員可以控制使用者層級的外寄 webhooks</span><span class="sxs-lookup"><span data-stu-id="9b1a9-363">Admins can control outgoing webhooks at the user level</span></span>
...
### <a name="transferring-incoming-calls"></a><span data-ttu-id="9b1a9-393">轉接來電</span><span class="sxs-lookup"><span data-stu-id="9b1a9-393">Transferring incoming calls</span></span>
...
<span data-ttu-id="9b1a9-418">您可以搜尋「審計記錄檔」，以在您的組織中查看倒班活動。</span><span class="sxs-lookup"><span data-stu-id="9b1a9-418">You can search the audit log to view Shifts activity in your organization.</span></span> <span data-ttu-id="9b1a9-419">[深入了解](/microsoftteams/audit-log-events)。</span><span class="sxs-lookup"><span data-stu-id="9b1a9-419">[Learn more](/microsoftteams/audit-log-events).</span></span>
...
## <a name="june-1-2020"></a><span data-ttu-id="9b1a9-429">2020年6月1日</span><span class="sxs-lookup"><span data-stu-id="9b1a9-429">June 1, 2020</span></span>

### <a name="raise-hand-in-meetings"></a><span data-ttu-id="9b1a9-430">在會議中舉手</span><span class="sxs-lookup"><span data-stu-id="9b1a9-430">Raise hand in meetings</span></span>

<span data-ttu-id="9b1a9-431">現在使用者可以在會議中提升虛擬手！</span><span class="sxs-lookup"><span data-stu-id="9b1a9-431">Users can now raise a virtual hand in a meeting!</span></span> <span data-ttu-id="9b1a9-432">其他參與者會在會議舞台中您的名稱旁和名冊中您的名字旁看到您的舉手。</span><span class="sxs-lookup"><span data-stu-id="9b1a9-432">Other participants will see your raised hand next to your name in the meeting stage and next to your name in the roster.</span></span> <span data-ttu-id="9b1a9-433">[深入了解](/microsoftteams/raise-hand-meetings)。</span><span class="sxs-lookup"><span data-stu-id="9b1a9-433">[Learn more](/microsoftteams/raise-hand-meetings).</span></span>

## <a name="may-15-2020"></a><span data-ttu-id="9b1a9-434">2020年5月15日</span><span class="sxs-lookup"><span data-stu-id="9b1a9-434">May 15, 2020</span></span>

### <a name="add-more-people-to-a-chat"></a><span data-ttu-id="9b1a9-435">將更多人員新增至聊天</span><span class="sxs-lookup"><span data-stu-id="9b1a9-435">Add more people to a chat</span></span>

<span data-ttu-id="9b1a9-436">我們現在可以將最多350人員新增至單一聊天線程。</span><span class="sxs-lookup"><span data-stu-id="9b1a9-436">We made it possible to now add up to 350 people to a single chat thread.</span></span>

## <a name="may-5-2020"></a><span data-ttu-id="9b1a9-437">2020 年 5 月 5 日</span><span class="sxs-lookup"><span data-stu-id="9b1a9-437">May 5, 2020</span></span>

### <a name="easily-access-meeting-options-from-within-a-teams-meeting-in-progress"></a><span data-ttu-id="9b1a9-438">在進行中的 Teams 會議中輕鬆存取會議選項</span><span class="sxs-lookup"><span data-stu-id="9b1a9-438">Easily access meeting options from within a Teams meeting in progress</span></span>

<span data-ttu-id="9b1a9-439">當您從 Teams 會議開始，只要在參與者窗格中提供輕鬆存取的連結，我們就能輕鬆地快速且輕鬆地變更其簡報者和前廳設定。</span><span class="sxs-lookup"><span data-stu-id="9b1a9-439">We're making it easier for meeting organizers to quickly and easily change their presenter and lobby settings once a Teams meeting starts by providing an easy to access link directly in the participants pane.</span></span> <span data-ttu-id="9b1a9-440">這項新功能將會出現在排程和「立即開會」會議上。</span><span class="sxs-lookup"><span data-stu-id="9b1a9-440">This new functionality will be present for both scheduled and “Meet now” meetings.</span></span>

### <a name="download-a-participant-report-in-a-teams-meeting"></a><span data-ttu-id="9b1a9-441">在 Teams 會議中下載參與者報告</span><span class="sxs-lookup"><span data-stu-id="9b1a9-441">Download a participant report in a Teams meeting</span></span>

<span data-ttu-id="9b1a9-442">會議召集人（特別是老師）通常需要知道誰加入其 Teams 會議。</span><span class="sxs-lookup"><span data-stu-id="9b1a9-442">Meeting organizers, especially teachers, often need to know who joined their Teams meetings.</span></span> <span data-ttu-id="9b1a9-443">您很快就可以在包含加入和離開時間的名單視圖中，下載參與者報告。</span><span class="sxs-lookup"><span data-stu-id="9b1a9-443">Soon you will be able to download a participant report, found in the roster view that includes join and leave times for participants.</span></span> <span data-ttu-id="9b1a9-444">在 [名單] 視圖中可用，會議召集人可以下載包含在召集人顯示時所加入之使用者的報告。</span><span class="sxs-lookup"><span data-stu-id="9b1a9-444">Available in the roster view, meeting organizers can download the report that includes those users who joined while the organizer was present.</span></span> <span data-ttu-id="9b1a9-445">只有在會議處於作用中狀態時，才可在會議內使用此功能。</span><span class="sxs-lookup"><span data-stu-id="9b1a9-445">This feature is only available within the meeting while the meeting is active.</span></span> <span data-ttu-id="9b1a9-446">可在桌面 (Windows 和 Mac) 和網路上使用。</span><span class="sxs-lookup"><span data-stu-id="9b1a9-446">Available on desktop (Windows and Mac) and the web.</span></span> <span data-ttu-id="9b1a9-447">[深入了解](/microsoftteams/teams-analytics-and-reports/meeting-attendance-report)。</span><span class="sxs-lookup"><span data-stu-id="9b1a9-447">[Learn more](/microsoftteams/teams-analytics-and-reports/meeting-attendance-report).</span></span>

## <a name="april-26-2020"></a><span data-ttu-id="9b1a9-448">2020年4月26日</span><span class="sxs-lookup"><span data-stu-id="9b1a9-448">April 26, 2020</span></span>

### <a name="include-system-audio-in-live-events"></a><span data-ttu-id="9b1a9-449">在即時事件中包含系統音訊</span><span class="sxs-lookup"><span data-stu-id="9b1a9-449">Include system audio in live events</span></span>

<span data-ttu-id="9b1a9-450">在即時事件期間共用桌面或視窗畫面時，live 事件中的簡報者和發生器現在可以包含系統音訊。</span><span class="sxs-lookup"><span data-stu-id="9b1a9-450">Presenters and producers in live events can now include system audio when sharing a desktop or window screen during the live event.</span></span> <span data-ttu-id="9b1a9-451">這可讓您的使用者聽到您正在共用內容的任何音訊部分。</span><span class="sxs-lookup"><span data-stu-id="9b1a9-451">This will allow your users to hear any audio part of the content you are sharing.</span></span>

## <a name="april-24-2020"></a><span data-ttu-id="9b1a9-452">2020年4月24日</span><span class="sxs-lookup"><span data-stu-id="9b1a9-452">April 24, 2020</span></span>

### <a name="team-and-channel-analytics"></a><span data-ttu-id="9b1a9-453">小組和通道分析</span><span class="sxs-lookup"><span data-stu-id="9b1a9-453">Team and channel analytics</span></span>

<span data-ttu-id="9b1a9-454">除了小組分析之外，現在您還可以查看通道層級的計量與深入瞭解。</span><span class="sxs-lookup"><span data-stu-id="9b1a9-454">In addition to team analytics, now you can also view channel level metrics and insights.</span></span> <span data-ttu-id="9b1a9-455">我們也將時間週期增加到 90 天，使得您可以分析資料的時間較長。</span><span class="sxs-lookup"><span data-stu-id="9b1a9-455">We've also enhanced the time period to 90 days so you can analyze data for longer periods.</span></span> <span data-ttu-id="9b1a9-456">除此之外，此版本還包括圍繞小組或管道的文章、回復和會議計數的新計量和圖表。</span><span class="sxs-lookup"><span data-stu-id="9b1a9-456">Apart from that, this release also includes new metrics and charts around the count of posts, replies, and meetings for a team or channel.</span></span> <span data-ttu-id="9b1a9-457">[深入了解](/microsoftteams/teams-analytics-and-reports/view-analytics)。</span><span class="sxs-lookup"><span data-stu-id="9b1a9-457">[Learn more](/microsoftteams/teams-analytics-and-reports/view-analytics).</span></span>

## <a name="april-20-2020"></a><span data-ttu-id="9b1a9-458">2020 年 4 月 20 日</span><span class="sxs-lookup"><span data-stu-id="9b1a9-458">April 20, 2020</span></span>

### <a name="enable-organizers-to-change-lobby-settings-for-dial-in-participants"></a><span data-ttu-id="9b1a9-459">使召集人可以變更撥入參與者的前廳流覽設定</span><span class="sxs-lookup"><span data-stu-id="9b1a9-459">Enable organizers to change lobby settings for dial-in participants</span></span>

<span data-ttu-id="9b1a9-460">此設定會控制以電話撥號的使用者是否直接加入會議，或不論 [ **自動承認人員** ] 設定，是否等候會議廳。</span><span class="sxs-lookup"><span data-stu-id="9b1a9-460">This setting controls whether people who dial in by phone join the meeting directly or wait in the lobby regardless of the **Automatically admit people** setting.</span></span>

## <a name="april-8-2020"></a><span data-ttu-id="9b1a9-461">2020年4月8日</span><span class="sxs-lookup"><span data-stu-id="9b1a9-461">April 8, 2020</span></span>

### <a name="customize-meeting-video-backgrounds"></a><span data-ttu-id="9b1a9-462">自訂會議影片背景</span><span class="sxs-lookup"><span data-stu-id="9b1a9-462">Customize meeting video backgrounds</span></span>

<span data-ttu-id="9b1a9-463">當您使用影片會議時，您現在可以選擇要使用的不同靜態背景圖像。</span><span class="sxs-lookup"><span data-stu-id="9b1a9-463">When you are meeting with video, you now have the choice of different static background images to use.</span></span> <span data-ttu-id="9b1a9-464">這可讓您顯示此影像，而不是您所在位置的實際背景。</span><span class="sxs-lookup"><span data-stu-id="9b1a9-464">This will let you show this image and not the actual background of where you are sitting.</span></span> <span data-ttu-id="9b1a9-465">[深入了解](/microsoftteams/meeting-policies-in-teams)。</span><span class="sxs-lookup"><span data-stu-id="9b1a9-465">[Learn more](/microsoftteams/meeting-policies-in-teams).</span></span>

## <a name="april-1-2020"></a><span data-ttu-id="9b1a9-466">2020年4月1日</span><span class="sxs-lookup"><span data-stu-id="9b1a9-466">April 1, 2020</span></span>

### <a name="teams-for-realwear"></a><span data-ttu-id="9b1a9-467">RealWear 的 Teams</span><span class="sxs-lookup"><span data-stu-id="9b1a9-467">Teams for RealWear</span></span>

<span data-ttu-id="9b1a9-468">Microsoft Teams 用戶端 RealWear 可讓 Frontline 工作者使用 RealWear 的 ruggedized head 安裝 wearables，以 Teams 100% 的免提，並使用 Teams 的視頻通話搜尋來自專家的遠端協助。</span><span class="sxs-lookup"><span data-stu-id="9b1a9-468">Microsoft Teams client for RealWear enables Frontline Workers using RealWear's ruggedized head-mounted wearables to operate Teams 100 percent hands-free and seek remote assistance from experts using Teams video calling.</span></span> <span data-ttu-id="9b1a9-469">[深入了解](/microsoftteams/flw-realwear)。</span><span class="sxs-lookup"><span data-stu-id="9b1a9-469">[Learn more](/microsoftteams/flw-realwear).</span></span>

## <a name="march-31-2020"></a><span data-ttu-id="9b1a9-470">2020 年 3 月 31 日</span><span class="sxs-lookup"><span data-stu-id="9b1a9-470">March 31, 2020</span></span>

### <a name="tag-youre-it"></a><span data-ttu-id="9b1a9-471">標記，您是</span><span class="sxs-lookup"><span data-stu-id="9b1a9-471">Tag, you're it</span></span>

<span data-ttu-id="9b1a9-472">建立標籤並將其指派給使用者，以便您可以 @mention 群組、角色、部門等。小組擁有者，請自行嘗試。</span><span class="sxs-lookup"><span data-stu-id="9b1a9-472">Create tags and assign people to them so you can @mention a group, role, department, etc. Team owners, try it out for yourselves.</span></span> <span data-ttu-id="9b1a9-473">前往小組，選取 [**更多選項**  >  **管理標記**]。</span><span class="sxs-lookup"><span data-stu-id="9b1a9-473">Go to a team, select **More options** > **Manage tags**.</span></span> <span data-ttu-id="9b1a9-474">[深入了解](/microsoftteams/manage-tags)。</span><span class="sxs-lookup"><span data-stu-id="9b1a9-474">[Learn more](/microsoftteams/manage-tags).</span></span>

## <a name="march-30-2020"></a><span data-ttu-id="9b1a9-475">2020 年 3 月 30 日</span><span class="sxs-lookup"><span data-stu-id="9b1a9-475">March 30, 2020</span></span>

### <a name="policy-based-recording-for-teams-calls-and-meetings"></a><span data-ttu-id="9b1a9-476">Teams 通話和會議的原則型錄製</span><span class="sxs-lookup"><span data-stu-id="9b1a9-476">Policy-based recording for Teams calls and meetings</span></span>

<span data-ttu-id="9b1a9-477">此功能可讓您透過 Microsoft 認證的軟體廠商自動錄製 Teams 通話和會議的原則。</span><span class="sxs-lookup"><span data-stu-id="9b1a9-477">This feature enables automatic policy-based recordings of Teams calls and meetings via Microsoft-certified software vendors.</span></span>

## <a name="march-25-2020"></a><span data-ttu-id="9b1a9-478">2020 年 3 月 25 日</span><span class="sxs-lookup"><span data-stu-id="9b1a9-478">March 25, 2020</span></span>

### <a name="manage-your-collaboration-bar-devices-in-microsoft-teams"></a><span data-ttu-id="9b1a9-479">在 Microsoft Teams 中管理共同作業條碼裝置</span><span class="sxs-lookup"><span data-stu-id="9b1a9-479">Manage your Collaboration Bar devices in Microsoft Teams</span></span>

<span data-ttu-id="9b1a9-480">作為系統管理員，您想要從 Microsoft Teams 系統管理中心管理所有共同作業列裝置。</span><span class="sxs-lookup"><span data-stu-id="9b1a9-480">As an admin, you want to manage all your Collaboration Bar devices from Microsoft Teams admin center.</span></span> <span data-ttu-id="9b1a9-481">您可以查看裝置的庫存，對裝置採取特定動作，並將命令遠端提供給所有裝置。</span><span class="sxs-lookup"><span data-stu-id="9b1a9-481">You can view inventory of devices, take specific actions on the devices and give commands remotely to all the devices.</span></span>
